...
Mobile.setText(findTestObject('Mobile/registerPage/form_Phone'), '123', 0)
...
Mobile.verifyElementText(findTestObject('Mobile/registerPage/alert_WhatsApp number must be 9-13 character'), 'WhatsApp number must be 9-13 character')
