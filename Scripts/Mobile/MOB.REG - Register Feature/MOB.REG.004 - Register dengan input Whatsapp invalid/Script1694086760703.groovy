...
Mobile.setText(findTestObject('Object Repository/Mobile_Register Page/form_Phone'), '123', 0)
...
Mobile.verifyElementText(findTestObject('Mobile_Register Page/alert_WhatsApp number must be 9-13 character'), 'WhatsApp number must be 9-13 character')
