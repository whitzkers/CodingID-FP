...
Mobile.setText(findTestObject('Object Repository/Mobile_Register Page/form_Password'), '1', 0)

Mobile.setText(findTestObject('Object Repository/Mobile_Register Page/form_ConfirmPassword'), '1', 0)
...
Mobile.verifyElementText(findTestObject('Mobile_Register Page/alert_Password atleast must contain alphanumeric (a-Z,0-9) with minim 8 characters'), 
