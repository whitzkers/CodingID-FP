...
Mobile.tap(findTestObject('Object Repository/Mobile_Register Page/btn_Sign Up with Google'), 0)

Mobile.verifyElementText(findTestObject('Mobile_Register Page/txt_Couldnt sign in'), 'Couldn\'t sign in')
