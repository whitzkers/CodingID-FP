...
Mobile.tap(findTestObject('Mobile/registerPage/btn_Lihat Konfirmasi Kata Sandi'), 0)

Mobile.verifyElementText(findTestObject('Mobile/registerPage/txt_Konfirmasi password Pssw0rd'), 'P@ssw0rd')
