...
WebUI.setText(findTestObject('Website/registerPage/form_Tanggal lahir'), '02-sep-2010')
...
WebUI.verifyElementText(findTestObject('Website/emailverificationPage/txt_Verifikasi Email'), 'Verifikasi Email')
