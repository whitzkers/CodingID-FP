...
WebUI.setText(findTestObject('Page_Coding.ID - Register/input_Tanggal lahir'), '02-sep-2010')
...
WebUI.verifyElementText(findTestObject('Page_Coding.ID - Verifikasi Email/span_Verifikasi Email'), 'Verifikasi Email')
