...
WebUI.setText(findTestObject('Object Repository/Page_Coding.ID - Update Profile/input_Fullname'), '')

WebUI.setText(findTestObject('Object Repository/Page_Coding.ID - Update Profile/input_Phone'), '088877776666')
...
WebUI.verifyElementText(findTestObject('Page_Coding.ID - Update Profile/Word_The whatsapp field is required'), 'The name field is required.')
